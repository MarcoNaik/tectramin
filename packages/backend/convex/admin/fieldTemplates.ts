...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const validFieldTypes = ["text", "number", "boolean", "date", "attachment", "displayText", "select", "multiSelect", "userSelect", "multiUserSelect", "entitySelect", "multiEntitySelect", "coordenated", "taskInstanceSelect"];
